...
author: Morgan Ridel
date: 2017-07-05
hero: ./images/color-198892_1280.jpg
---
...
![Couleurs aléatoire en un ligne Javascript](./images/colorsimple.png)
...
randomColor()
```
![](./images/colorscript1.png)
```javascript
randomColor({hue:'red'})
```
![](./images/couleurscript2.png)
```javascript
randomColor({hue: 'blue', luminosity: 'bright'}
```
![](./images/couleurscript3.png)
